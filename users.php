...
$db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            ...
            $stmt = $db->query('SELECT username,postTitle FROM blog_posts ORDER BY username');
            while($row = $stmt->fetch()){
                ...
                <td>
                    <a href="edit-post.php?id=<?php echo $row['postTitle'];?>">Edit</a>
                     
                    <?php {?>
                        | <a href="javascript:deluser('<?php echo $row['username'];?>','<?php echo $row['postTitle'];?>')">Delete</a>
                    <?php } ?>
                </td>
